...
function loadScript(callback) {
	...
	var googleAPIKey = "AIzaSyCyHCJHcN8xLyPYyJSrvka2KFFleGyYVpM";
	var googleAPIUrl = "https://maps.googleapis.com/maps/api/js";

	var srcURL 		 = googleAPIUrl + '?key=AIzaSyCyHCJHcN8xLyPYyJSrvka2KFFleGyYVpM' + googleAPIKey 
							+ '&callback=initMap' + callback;
